...
public class TileController : MonoBehaviour
{
    ...
    private static readonly Vector2[] adjacentDirection = new Vector2[] { Vector2.up,
                                                                            Vector2.down,
                                                                            Vector2.left,
                                                                            Vector2.right };
    ...
    {
        // set destroyed dengan mengubah bool, id, dan nama
        IsDestroyed = true;
        id = -1;
        name = "TILE_NULL";
    ...
    // gak tau bang aku gak paham coroutine
    ...
    #region Adjacent
    // mendapatkan tile adjacent dari vector
    ...
    // loop untuk mendapatkan semua direction
    ...
    // untuk setiap sumbu x dan y, simpan matching tiles dalam sebuah list
