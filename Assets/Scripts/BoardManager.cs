...
public class BoardManager : MonoBehaviour
{
    ...
    // untuk menyimpan semua destroyed tiles
    ...
    // mendapatkan semua tile yang didrop
    ...
    private void ProcessMatches()
    {
        ...
        // memanggil coroutine clearmatches dengan list matching tiles
    ...
    private IEnumerator ClearMatches(List<TileController> matchingTiles, System.Action onCompleted)
    {
        ...
        // mengecek apakah sudah clear semua di list
        yield return new WaitUntil(() => { return IsAllTrue(isCompleted); });
        onCompleted?.Invoke();
    }
    ...
    // mengecek tile matching pada boardnya
    ...
    // untuk mengambil id yang sekiranya tidak duplikat dengan jejer sebelumnya (x-1,y) dan (x-2,y)
    // x, y-1 dan x, y-2
